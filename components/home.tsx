...
import type { DbGame } from "@/lib/supabase/queries";
...
function MiniCard({ game, onClick }: { game: DbGame; onClick: () => void }) {
  return (
...
export default function Home({ games }: { games: DbGame[] }) {
  useReveal();
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-ctas">
            <button className="btn xl pulse" onClick={() => router.push("/")}>
              ▶ EXPLORAR JUEGOS
            </button>
            <button
